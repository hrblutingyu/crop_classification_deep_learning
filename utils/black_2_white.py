...
def convert_white_black(imgFile,saveAsFile):
...
# 批量转换,参数为文件夹
def convert_white_black_bat(imgFoler):
    # get (i, j) positions of all RGB pixels that are black (i.e. [0, 0, 0])
...
convert_white_black("../datasets/shuangcheng_result_black_2.png","../datasets/shuangcheng_result_black_3.png")