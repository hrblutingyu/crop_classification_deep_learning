...
height = 0
channels = 0
report = "./evaluating_indicator/mishan_report_svm_kernel.txt"
...
def Classifier_svm_kernel():  # 训练并生成模型
    ...
    # 保存分类器
    with open("./trainedModels/svm_kernel_1.pkl", "wb") as f:
    ...
    cv2.imwrite("../datasets/mishan/roi_3_pred_svm_kernel_linear.tif", result_img)
