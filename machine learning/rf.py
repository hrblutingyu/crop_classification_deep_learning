...
height = 0
channels = 0
report = "./evaluating_indicator/mishan_report_rf.txt"
...
def Classifier_rf():  # 训练并生成模型
    ...
    classifier = RandomForestClassifier(n_estimators=200,bootstrap=False, max_features='log2')
    print("training......")
    ...
    # 保存分类器
    with open("./trainedModels/rf_0.pkl", "wb") as f:
    ...
    cv2.imwrite("../datasets/mishan/roi_3_pred_rf.tif", result_img)
